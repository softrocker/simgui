...
// Main code
int simgui_init(void(*draw_func)(void))
{
    // Setup SDL
    ...
    while (!done)
    {
        ...
        if (draw_func)
        {
            // Делаем, чтобы главное окно растягивалось на всю ширину SDL-окна:
            ...
            // Открываем главное окно отрисовки:
            ...
            // Выполняем пользовательскую функцию отрисовки:
            draw_func();
